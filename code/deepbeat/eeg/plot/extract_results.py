...
from deepbeat.pylearn2ext.util import load_yaml_file, process_dataset, aggregate_classification;
...
def _extract_best_results(channels, mode='f1', check_dataset='valid'):
    print channels.keys();
    
    best_results = []; 
    for channel in check_channels[mode]:
